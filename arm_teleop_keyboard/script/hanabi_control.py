...
def PositionUpdater(X_aruco, Y_aruco, Cube_number, row, movement, State = "Normal"):
    if movement == "Drop":
        ...
        if Cube_number == 1 and row == 1:
            ...
            X_update = -(340-Y_aruco)*0.01/65
            Y_update = (209-X_aruco)*0.015/82
        elif Cube_number == 4 and row == 1:
            X_update = -(330-Y_aruco)*0.01/65
            Y_update = (209-X_aruco)*0.015/82
        elif Cube_number == 5 and row == 1:
            ...
            X_update = -(350-Y_aruco)*0.01/65
            Y_update = (209-X_aruco)*0.015/82
        elif Cube_number == 2 and row == 2:
            X_update = -(350-Y_aruco)*0.01/65
            Y_update = (209-X_aruco)*0.015/82
        elif Cube_number == 3 and row == 2:
            X_update = -(350-Y_aruco)*0.006/65
            Y_update = (209-X_aruco)*0.015/82
        elif Cube_number == 4 and row == 2:
            X_update = -(350-Y_aruco)*0.01/65
            Y_update = (209-X_aruco)*0.015/82
...
def run():
    ...
    if movement == "Life":
        ...
        if State == "Droped":
            ...
            # Step 1 Going upper of the object
            goal_orientation = [0, 0, pi]  # Adjust as needed
            goal_position = [X_pose, Y_pose+0.025, -0.13]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 4)
            update_head_cube(Cube_number)
            rospy.sleep(2)

            goal_position = [X_pose, Y_pose+0.025, -0.20]  # Adjust as needed
            if Cube_number == 5 and row == 2:
                goal_position = [X_pose-0.015, Y_pose+0.025, -0.20]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 2)
            rospy.sleep(2)
            gripper_image_flag = 1
            rospy.sleep(2)
            ...
            goal_position = [X_pose+X_update, Y_pose+Y_update+0.025, -0.26]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 3)
            rospy.sleep(3)
        ...
        if movement == "Forward":
            ...
            goal_position = [X_pose, Y_pose+y_left, -0.22]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 2)
            rospy.sleep(2)

            goal_position = [X_pose, Y_pose+y_left, -0.23]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 1)
            rospy.sleep(1)

            goal_position = [X_pose, Y_pose+y_left+0.02, -0.238]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 1)
            rospy.sleep(1)

            goal_position = [X_pose-0.001, Y_pose+y_left+0.045, -0.24]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 1)
            rospy.sleep(1)

            goal_position = [X_pose-0.001, Y_pose+y_left+0.064, -0.26]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 1)
            rospy.sleep(1)

            goal_position = [X_pose-0.001, Y_pose+y_left+0.068, -0.27]  # Adjust as needed
            move_to_goal_position(goal_position, goal_orientation, 1)
            rospy.sleep(1)
