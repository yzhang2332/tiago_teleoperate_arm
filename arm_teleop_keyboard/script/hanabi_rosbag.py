...
def signal_handler(sig, frame):
    ...
    os.killpg(os.getpgid(throttle_rgb_gripper_process.pid), signal.SIGINT)
    ...
    throttle_rgb_gripper_process.wait()
...
directory = "/home/pal/rosbags/hanabi/"
...
# Throttle command for the gripper camera topic
throttle_rgb_gripper_command = "rosrun topic_tools throttle messages /camera/image_raw 4.0 /camera/gripper_image_raw_throttled"
throttle_rgb_gripper_process = subprocess.Popen(throttle_rgb_gripper_command, shell=True, preexec_fn=os.setsid)
...
topics = "/xtion/rgb/image_raw_throttled /joint_states /audio /robot_action /aruco_pose_robot_camera /camera/gripper_image_raw_throttled /play_audio"
